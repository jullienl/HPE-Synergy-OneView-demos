...
#
# Commands:
#   `getsp <name>` - Get the server profile <name> information
#
...
module.exports = (robot) ->
  ...
  robot.respond /getsp (.*)/i, (msg) ->
    # i: case insensitive - $: at the end - ^: at the begining
    msg.send "Ok, let me see what are the information of that server profile..."
    name = msg.match[1]
