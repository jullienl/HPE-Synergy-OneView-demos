...
module.exports = (robot) ->
  ...
  robot.respond /getenclosure (.*)/i, (msg) ->
    # i: case insensitive - $: at the end - ^: at the begining
    msg.send "Ok, let me see what are the information of that frame..."
    name = msg.match[1]
