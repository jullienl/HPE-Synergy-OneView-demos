# Description:
#   Gets the OneView informations:
#       - IP address of the HPE Synergy Composer (OneView) 
#       - The username of a OneView user with Infrastructure administrator role
#       
# Commands:
